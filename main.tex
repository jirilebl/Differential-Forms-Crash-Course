...
In this setup, functions are called $0$-forms.  $0$-forms are ``integrated''
...
Suppose $C$ is parametrized by $t$
...
\right) \, dt,
$$
which is not difficult to integrate.
...
There is another way to see what this integral is using the change of
